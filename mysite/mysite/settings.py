...
MIDDLEWARE = [
    ...
    '_common.middleware.users.CurrentUserMiddleware',  # Обновление autor к каждой записи
    '_common.middleware.advanced_middleware.AdvancedStealth403Middleware',  # Подстановка 404 вместо 403 ошибки
