    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('tabl', 'Таблица'), ('ext_tabl', 'Внешняя таблица'), ('view', 'Представление')], default='tabl', max_length=10, verbose_name='Тип таблицы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('md_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='dba.columnmdtype')),
