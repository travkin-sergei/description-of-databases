...
from ..filters import BaseFilter, SchemaTableFilter
from ..models import Base, Schemas, SchemaTable


# from ..models import Base, Schemas
...
#     model = Base
#     template_name = 'my_metla/database-list.html'  # Явно указываем путь к шаблону
#     context_object_name = 'bases'
#     paginate_by = 25
#     ordering = ['name__name', 'host', 'port']
#
...
#         context['title'] = 'Список баз данных'
#         return context


class SchemaTablesView(ListView):
    model = Schemas
    ...
    def get_queryset(self):
        ...
        return super().get_queryset().filter(base_id=base_id, is_active=True)
